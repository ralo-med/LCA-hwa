  ...
  return (
    <InfoPageLayout title="서비스 소개">
      ...
      <section className="space-y-4">
        <h2 className="text-lg font-semibold">제공 서비스</h2>
        <div className="grid gap-3 sm:grid-cols-2">
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-base">생존 대시보드</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">
              cBioPortal 공개 연구 코호트를 바탕으로 Kaplan–Meier 생존 곡선과
              요약 통계를 제공합니다.
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-base">환자 안내 챗봇</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">
              NCCN 환자용 가이드라인 PDF를 벡터 검색해 질문에 답하고, 관련
              원문 페이지를 함께 보여 줍니다.
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-base">가이드라인 PDF</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">
              조기·전이성 비소세포폐암, 소세포폐암 환자 안내 원문을 직접
              열람할 수 있습니다.
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-base">의료진 연결</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">
              병원 폐암 의료진 정보 페이지로 연결해 실제 진료 상담을 이어갈 수
              있습니다.
            </CardContent>
          </Card>
        </div>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold">데이터와 AI 분석 과정</h2>
        <ol className="list-decimal space-y-2 pl-5">
          <li>
            <strong>가이드라인 수집</strong>: NCCN Guidelines for Patients
            폐암 환자용 PDF를 수집·정리합니다.
          </li>
          <li>
      ...
      <section className="space-y-3 rounded-lg border border-amber-200/80 bg-amber-50/50 p-4 dark:border-amber-900/50 dark:bg-amber-950/20">
        <h2 className="text-lg font-semibold">안전성 및 면책</h2>
